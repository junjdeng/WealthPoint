...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/index/index"],{"2b91":function(t,e,a){"use strict";a.r(e);var n=a("6e1f"),i=a.n(n);for(var o in n)"default"!==o&&function(t){a.d(e,t,function(){return n[t]})}(o);e["default"]=i.a},4820:function(t,e,a){"use strict";a.r(e);var n=a("cbbe"),i=a("2b91");for(var o in i)"default"!==o&&function(t){a.d(e,t,function(){return i[t]})}(o);a("8989");var s=a("2877"),r=Object(s["a"])(i["default"],n["a"],n["b"],!1,null,null,null);e["default"]=r.exports},"56d8":function(t,e,a){},"6e1f":function(t,e,a){"use strict";(function(t){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var n=r(a("ce167")),i=a("25f1"),o=r(a("1de3")),s=a("2966");function r(t){return t&&t.__esModule?t:{default:t}}a("7919"),a("abba");var u,c=function(){return a.e("components/uni-icon/uni-icon").then(a.bind(null,"fc60"))},d=null,l=null,h={data:function(){return{news:"暂无公告",updateStatus:!1,showPop:!1,cWidth:"",cHeight:"",pixelRatio:.98,serverData:"",das:[],week:[],webview:null,cWidth2:"",cHeight2:"",serverData2:"",das2:[],week2:[],theNow:0,low:0,high:0,amount:0,opens:0,cent:0,num:0,color:0}},components:{uniIcon:c},onShow:function(){null!=s.config.User&&t.getStorage({key:"isTodaySign",success:function(t){t.data?this.showPop=!1:this.showPop=!0}}),this.getBTC()},onLoad:function(){o.default.balance(),this._data.das=[.1,.2,.8,.4,.9,.9,.6],this._data.week=["5.29","5.30","5.31","6.01","6.02","6.03","6.04"],u=this,this.cWidth=t.upx2px(680),this.cHeight=t.upx2px(460),this.getServerData(),this._data.das2=[100,220,280,340,290,300,320],this.getServerData2()},methods:{getNews:function(){var t=this;(0,i.djRequest)({url:"/api/news",data:{start:0,length:1},success:function(e){200==e.data.status&&e.data.data.data.length>0&&(t.news=e.data.data.data[0].title)}})},getBTC:function(){var e=this;t.request({url:"https://api.huobi.pro/market/detail",data:{symbol:"btcusdt"},header:{"Content-Type":"application/x-www-form-urlencoded","User-Agent":"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/39.0.2171.71 Safari/537.36","Accept-Language":"zh-cn"},method:"GET",success:function(t){console.log(t," at pages\\index\\index.vue:215"),e.amount=Number(t.data.tick.amount).toFixed(2),e.high=Number(t.data.tick.high).toFixed(2),e.low=Number(t.data.tick.low).toFixed(2),e.theNow=Number(t.data.tick.close).toFixed(2),e.opens=Number(t.data.tick.open).toFixed(2),e.num=Number(e.theNow-e.opens).toFixed(2),e.cent=Number(e.num/e.opens*100).toFixed(2),e.color=Number(e.low-e.opens)},fail:function(t){console.log(t,4," at pages\\index\\index.vue:226")}})},navTo:function(e){t.navigateTo({url:e.currentTarget.dataset.url})},getServerData:function(){var t=this,e={categories:[],series:[]};e.categories=t._data.week,e.series=[{data:t._data.das,name:"",color:"#FF5533"}],t._data.das=e.series[0].data,u.CanvasData("canvas",e)},CanvasData:function(t,e){l=new n.default({$this:u,canvasId:t,type:"line",fontSize:11,legend:!1,dataLabel:!1,dataPointShape:!1,background:"transparent",dataLineColor:"#333333",pixelRatio:u.pixelRatio,categories:e.categories,series:e.series,animation:!1,xAxis:{dashLength:8,gridColor:"transparent"},yAxis:{dashLength:8,splitNumber:5,min:0,disabled:!1,max:2,format:function(t){return t}},width:u.cWidth*u.pixelRatio,height:u.cHeight*u.pixelRatio,extra:{lineStyle:"curve"}})},touchCanvas:function(t){l.showToolTip(t,{format:function(t,e){return t.data+"%"}})},hidePop:function(){this.showPop=!1},getServerData2:function(){var t=this,e={categories:[],series:[]};e.categories=t._data.week,e.series=[{data:t._data.das2,name:"",color:"#FF5533"}],t._data.das2=e.series[0].data,u.showColumn("canvasColumn",e)},showColumn:function(t,e){d=new n.default({$this:u,canvasId:t,type:"column",legend:!1,fontSize:11,background:"#FFFFFF",pixelRatio:u.pixelRatio,animation:!0,categories:e.categories,series:e.series,xAxis:{disableGrid:!0},yAxis:{dashLength:8,splitNumber:4,min:0,disabled:!1,max:500,format:function(t){return t}},dataLabel:!0,width:u.cWidth*u.pixelRatio,height:u.cHeight*u.pixelRatio,extra:{column:{type:"group",width:u.cWidth*u.pixelRatio*.45/e.categories.length}}})},touchColumn:function(t){d.showToolTip(t,{format:function(t,e){return"object"===typeof t.data?e+" "+t.name+":"+t.data.value:e+" "+t.name+":"+t.data}})}}};e.default=h}).call(this,a("6e42")["default"])},8989:function(t,e,a){"use strict";var n=a("56d8"),i=a.n(n);i.a},cbbe:function(t,e,a){"use strict";var n=function(){var t=this,e=t.$createElement;t._self._c},i=[];a.d(e,"a",function(){return n}),a.d(e,"b",function(){return i})}},[["798f","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/index/btc","components/uni-icon/uni-icon"],{"0db0":function(t,e,n){"use strict";var o=function(){var t=this,e=t.$createElement;t._self._c},i=[];n.d(e,"a",function(){return o}),n.d(e,"b",function(){return i})},"407c":function(t,e,n){"use strict";var o=n("9001"),i=n.n(o);i.a},"418e":function(t,e,n){"use strict";n.r(e);var o=n("0db0"),i=n("6f73");for(var s in i)"default"!==s&&function(t){n.d(e,t,function(){return i[t]})}(s);n("407c");var c=n("2877"),a=Object(c["a"])(i["default"],o["a"],o["b"],!1,null,null,null);e["default"]=a.exports},"57da":function(t,e,n){"use strict";n.r(e);var o=n("5e94"),i=n.n(o);for(var s in o)"default"!==s&&function(t){n.d(e,t,function(){return o[t]})}(s);e["default"]=i.a},"5e94":function(t,e,n){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var o={name:"uni-icon",props:{type:String,color:String,size:[Number,String]},computed:{fontSize:function(){return"".concat(this.size,"px")}},methods:{onClick:function(){this.$emit("click")}}};e.default=o},"6b31":function(t,e,n){},"6f73":function(t,e,n){"use strict";n.r(e);var o=n("f471"),i=n.n(o);for(var s in o)"default"!==s&&function(t){n.d(e,t,function(){return o[t]})}(s);e["default"]=i.a},9001:function(t,e,n){},9311:function(t,e,n){"use strict";var o=n("6b31"),i=n.n(o);i.a},f471:function(t,e,n){"use strict";(function(t){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;o(n("fc60"));function o(t){return t&&t.__esModule?t:{default:t}}var i={data:function(){return{list:[]}},onShow:function(){var e=this;e.list=[],t.request({url:"https://api.huobi.pro/market/tickers",header:{"Content-Type":"application/x-www-form-urlencoded","User-Agent":"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/39.0.2171.71 Safari/537.36",timeout:8e3},method:"GET",success:function(t){var n=t.data.data;n.forEach(function(t){if("usdt"==t.symbol&&console.log(t.open," at pages\\index\\btc.vue:53"),"btcusdt"==t.symbol||"ethusdt"==t.symbol||"eosusdt"==t.symbol||"xrpusdt"==t.symbol||"bchusdt"==t.symbol||"etcusdt"==t.symbol||"ltcusdt"==t.symbol||"bsvusdt"==t.symbol||"dashusdt"==t.symbol||"adausdt"==t.symbol||"trxusdt"==t.symbol||"atomusdt"==t.symbol||"omgusdt"==t.symbol||"neousdt"==t.symbol){if(!t.hasOwnProperty("icon"))switch(t.symbol){case"btcusdt":t.icon="../../static/images/coin/BTC.png";break;case"ethusdt":t.icon="../../static/images/coin/ETH.png";break;case"ltcusdt":t.icon="../../static/images/coin/LTC.png";break;case"neousdt":t.icon="../../static/images/coin/NEO.png";break;case"omgusdt":t.icon="../../static/images/coin/OMG.png";break;case"atomusdt":t.icon="../../static/images/coin/atom.png";break;case"eosusdt":t.icon="../../static/images/coin/EOS.png";break;case"adausdt":t.icon="../../static/images/coin/ADA.png";break;case"etcusdt":t.icon="../../static/images/coin/ETC.png";break;case"bsvusdt":t.icon="../../static/images/coin/BCH.png";break;case"bchusdt":t.icon="../../static/images/coin/BCH.png";break;case"dashusdt":t.icon="../../static/images/coin/DASH.png";break;case"xrpusdt":t.icon="../../static/images/coin/XRP.png";break;case"trxusdt":t.icon="../../static/images/coin/trx.png";break}t.hasOwnProperty("cat")||(t.cat=t.symbol.replace(/usdt/g,"").toUpperCase()),t.hasOwnProperty("num")||(t.num=(100*(Number(Number(t.close)-Number(t.open))/Number(t.open)).toFixed(4)).toFixed(2)),t.high=Number(t.high).toFixed(2),t.low=Number(t.low).toFixed(2),t.close=Number(t.close).toFixed(2),t.hasOwnProperty("price")||(t.price=(6.86*t.close).toFixed(2)),e.list.push(t)}})},fail:function(t){console.log(t,4," at pages\\index\\btc.vue:123")}})}};e.default=i}).call(this,n("6e42")["default"])},f6a5:function(t,e,n){"use strict";var o=function(){var t=this,e=t.$createElement;t._self._c},i=[];n.d(e,"a",function(){return o}),n.d(e,"b",function(){return i})},fc60:function(t,e,n){"use strict";n.r(e);var o=n("f6a5"),i=n("57da");for(var s in i)"default"!==s&&function(t){n.d(e,t,function(){return i[t]})}(s);n("9311");var c=n("2877"),a=Object(c["a"])(i["default"],o["a"],o["b"],!1,null,null,null);e["default"]=a.exports}},[["3492","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/index/sign"],{"1acb":function(n,t,a){"use strict";(function(n){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var i=a("25f1"),e=s(a("1de3")),u=a("2966");function s(n){return n&&n.__esModule?n:{default:n}}var o=function(){return a.e("components/uni-icon/uni-icon").then(a.bind(null,"fc60"))},c={data:function(){return{signTxt:"签到领积分",signNum:0,signList:[]}},onNavigationBarButtonTap:function(t){n.navigateTo({url:"signRecord"})},onShow:function(){e.default.balance()},components:{uniIcon:o},onLoad:function(){this.signNum=u.config.balance.sign,this.getSignData();var t=this;n.getStorage({key:"isTodaySign",success:function(n){n.data&&(t.signTxt="今日已签到")}})},methods:{navTo:function(t){n.navigateTo({url:t.currentTarget.dataset.url})},sign:function(){if("今日已签到"!=this.signTxt){var t=this;(0,i.djRequest)({url:"/api/sign",data:{},success:function(a){console.log(a," at pages\\index\\sign.vue:112"),200==a.data.status&&(e.default.TostUtil(a.data.message),t.signTxt="今日已签到",n.setStorage({key:"isTodaySign",data:!0,success:function(){}}),t.getSignData())}})}},getSignData:function(){var n=this;(0,i.djRequest)({url:"/api/sign/sign_list",data:{start:0,length:7},success:function(t){200==t.data.status&&(n.signList=t.data.data)}})},switch1Change:function(n){console.log("switch1 发生 change 事件，携带值为",n.target.value," at pages\\index\\sign.vue:142")}}};t.default=c}).call(this,a("6e42")["default"])},"1bcd":function(n,t,a){},"3ff1":function(n,t,a){"use strict";a.r(t);var i=a("da3f"),e=a("638f");for(var u in e)"default"!==u&&function(n){a.d(t,n,function(){return e[n]})}(u);a("a57d");var s=a("2877"),o=Object(s["a"])(e["default"],i["a"],i["b"],!1,null,null,null);t["default"]=o.exports},"638f":function(n,t,a){"use strict";a.r(t);var i=a("1acb"),e=a.n(i);for(var u in i)"default"!==u&&function(n){a.d(t,n,function(){return i[n]})}(u);t["default"]=e.a},a57d:function(n,t,a){"use strict";var i=a("1bcd"),e=a.n(i);e.a},da3f:function(n,t,a){"use strict";var i=function(){var n=this,t=n.$createElement;n._self._c},e=[];a.d(t,"a",function(){return i}),a.d(t,"b",function(){return e})}},[["a7db","common/runtime","common/vendor"]]]);
});
