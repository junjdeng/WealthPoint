...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/index/extension"],{"2b8e":function(n,e,t){"use strict";(function(n){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var t={data:function(){return{arr:["/static/images/t1.png"]}},onLoad:function(){},methods:{yulan:function(){var e=this;n.previewImage({urls:e.arr,current:"0",longPressActions:{itemList:["保存图片"],success:function(n){0==n.tapIndex&&e.saveFile(e.arr[n.index])},fail:function(n){console.log(n.errMsg," at pages\\index\\extension.vue:33")}}})},saveFile:function(e){n.showModal({content:"是否保存图片?",success:function(t){t.confirm&&n.downloadFile({url:e,success:function(e){console.log(e," at pages\\index\\extension.vue:46"),200===e.statusCode&&n.saveImageToPhotosAlbum({filePath:e.tempFilePath,success:function(){n.showToast({title:"保存成功",icon:"none"})},fail:function(){n.showToast({title:"保存失败，请稍后重试",icon:"none"})}})}})}})}}};e.default=t}).call(this,t("6e42")["default"])},"564a":function(n,e,t){"use strict";var o=function(){var n=this,e=n.$createElement;n._self._c},i=[];t.d(e,"a",function(){return o}),t.d(e,"b",function(){return i})},9721:function(n,e,t){"use strict";t.r(e);var o=t("2b8e"),i=t.n(o);for(var a in o)"default"!==a&&function(n){t.d(e,n,function(){return o[n]})}(a);e["default"]=i.a},d038:function(n,e,t){},dcf8:function(n,e,t){"use strict";var o=t("d038"),i=t.n(o);i.a},df6c:function(n,e,t){"use strict";t.r(e);var o=t("564a"),i=t("9721");for(var a in i)"default"!==a&&function(n){t.d(e,n,function(){return i[n]})}(a);t("dcf8");var u=t("2877"),c=Object(u["a"])(i["default"],o["a"],o["b"],!1,null,null,null);e["default"]=c.exports}},[["ec2e","common/runtime","common/vendor"]]]);
});
