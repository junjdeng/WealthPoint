...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/index/extension"],{"2b8e":function(n,e,t){"use strict";(function(n){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var t={data:function(){return{arr:["/static/images/t1.png","http://b.hiphotos.baidu.com/image/h%3D300/sign=ad628627aacc7cd9e52d32d909032104/32fa828ba61ea8d3fcd2e9ce9e0a304e241f5803.jpg"]}},onLoad:function(){},methods:{yulan:function(){var e=this;n.previewImage({urls:e.arr,current:"0",longPressActions:{itemList:["保存图片"],success:function(n){0==n.tapIndex&&e.saveFile(e.arr[n.index])},fail:function(n){console.log(n.errMsg," at pages\\index\\extension.vue:35")}}})},saveFile:function(e){n.showModal({content:"是否保存图片?",success:function(t){t.confirm&&n.downloadFile({url:e,success:function(e){console.log(e," at pages\\index\\extension.vue:48"),200===e.statusCode&&n.saveImageToPhotosAlbum({filePath:e.tempFilePath,success:function(){n.showToast({title:"保存成功",icon:"none"})},fail:function(){n.showToast({title:"保存失败，请稍后重试",icon:"none"})}})}})}})}}};e.default=t}).call(this,t("6e42")["default"])},9721:function(n,e,t){"use strict";t.r(e);var o=t("2b8e"),a=t.n(o);for(var i in o)"default"!==i&&function(n){t.d(e,n,function(){return o[n]})}(i);e["default"]=a.a},af4a:function(n,e,t){"use strict";var o=function(){var n=this,e=n.$createElement;n._self._c},a=[];t.d(e,"a",function(){return o}),t.d(e,"b",function(){return a})},d038:function(n,e,t){},dcf8:function(n,e,t){"use strict";var o=t("d038"),a=t.n(o);a.a},df6c:function(n,e,t){"use strict";t.r(e);var o=t("af4a"),a=t("9721");for(var i in a)"default"!==i&&function(n){t.d(e,n,function(){return a[n]})}(i);t("dcf8");var c=t("2877"),u=Object(c["a"])(a["default"],o["a"],o["b"],!1,null,null,null);e["default"]=u.exports}},[["ec2e","common/runtime","common/vendor"]]]);
});
