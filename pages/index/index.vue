	...
	<view class="container">
		...
		<view class="section section2">
			<view class="notice flex-start">
				<uni-icon type="sound" class="sound_icon" size="14" color="#CCA366" style="position:relative;top:-7upx!important;"></uni-icon>
				<text style="color:#CCA366!important;font-weight:500;">云头条</text>
				<text class="ellipsis ">{{ news }}</text>
				<text class="" data-url="newsList" @tap="navTo">
					更多
		...
		<view class="section section3">
			<view class="section_title">
				<view>BTC行情</view>
				<view class="flex1 rt " data-url="btc" @tap="navTo">
					更多
					<uni-icon type="forward" class="forward" size="16" color="#999999"></uni-icon>
				</view>
			</view>
			...
			djRequest({
				...
				success: function(res) {
					...
					for (let obj in orignData) {
						weekArr.push(obj);
						weekNumber.push(String(orignData[obj].number / 100.0));
					}
