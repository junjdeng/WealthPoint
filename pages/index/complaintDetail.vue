<template>
	<view class="contain">
		<view class="doflex" style="color:#333;font-weight:500;">投诉:</view>
		<view class="doflex">投诉帐户：{{info.toUsername}}</view>
		<view class="doflex">订单编号：{{info.orderNumber}}</view>
