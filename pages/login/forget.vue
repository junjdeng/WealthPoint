<template>
	<view>
		<form class="login_form" @submit="formSubmit">
			...
			<view class="uni-form-item uni-column">
				<input class="uni-input" password type="text" v-model.trim="userPwd" placeholder="新密码" />
			</view>
			<view class="uni-form-item uni-column">
				<input class="uni-input" password type="text" v-model.trim="userPwd" placeholder="确认新密码" />
			</view>
			<view class="uni-btn-v">
				<button formType="submit">重置</button>
			</view>
		</form>
	</view>
</template>
